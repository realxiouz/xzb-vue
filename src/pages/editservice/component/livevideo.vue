    ...
    <div class="description">
      ...
      <el-form label-width="80px" ref="form" :model="form" :label-position="labPosition" :rules='formRule' style="max-width:800px">
        ...
        <el-form-item label="上课时间">
          <el-col :span="13">
            <el-form-item prop="time">
              <el-date-picker type="datetime" placeholder="选择上课时间" v-model="form.time" style="width: 100%; " :picker-options="pickerOption"></el-date-picker>
            </el-form-item>
          </el-col>
        ...
        <el-form-item label="上传讲义">
          <el-upload class="upload" action="/api/uploadAttach" :on-success="handleSuccessAttach" :file-list="attachList">
        ...
        <el-form-item label="上传封面" prop="img">
          <el-upload class="upload" action="/api/uploadImage" :limit="1" :on-success="handleImgSuccess" :on-error="handleImgError" ref="imgUpload" :before-upload="beforeImgUpload" list-type="picture" :on-remove="handleImgRemove" :file-list="imgList">
            <el-button type="primary">点击上传</el-button>
...
import livevideoVue from "../../list/components/livevideo.vue";
export default {
  data() {
    return {
      majorObj: null,
      ...
      this.$refs.form.validate(valid => {
        if (!valid) {
          ...
          let p = {
            ...
            teacher_percent: this.formSpread.checked2
              ? 0
              : this.formSpread.rate2,
  ...
  mounted() {
    ...
    getlivevideo(p).then(res => {
      ...
      if (res.image) {
        ...
        this.form.img = res.image;
      }
      //附件列表
      if (res.attach) {
        this.attachList.push({ url: res.attach });
