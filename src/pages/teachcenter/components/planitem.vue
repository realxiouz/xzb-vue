            ...
            <el-col :xs="24" :sm="24" :md="18" :lg="18" :xl="18">
                <div class="info">
                    ...
                    <div class="action">
                        ...
                        <div>
                            <el-button type="primary" @click="handleSendToClass(bean)">发送到班级</el-button>
                        </div>
                    </div>
                </div>
            </el-col>
        </el-row>
        <div class="send-class" v-if="bean.sendedclass.length > 0">
            <div class="sended">已发送至以下班级:</div>
            <ul>
                <li v-for="item in bean.sendedclass" :key="item.id">{{item.name}}</li>
            </ul>
        </div>
    </div>
</template>
